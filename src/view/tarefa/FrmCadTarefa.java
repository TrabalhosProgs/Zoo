 ...
 * @author william
 */
public class FrmCadTarefa extends javax.swing.JDialog {

    /**
     * Creates new form FrmCadTarefa
     */
    public FrmCadTarefa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        ljTituloCabecalho.setText("Cadastro de Tarefa");
    ...
    private void jbGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGravarActionPerformed
        ...
        Tarefa tarefa = new Tarefa(0, jtfDescricao.getText());
        try {
            if(selecionado == null){
                new TarefaDAO().inserir(tarefa);
                tarefa.setId(new TarefaDAO().buscarMaiorID());
            }else{
                tarefa.setId(selecionado.getId());
                new TarefaDAO().alterar(tarefa);
            }
            
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, "Erro ao gravar Tarefa ..."+ex.getMessage());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCadTarefa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmCadTarefa dialog = new FrmCadTarefa(new javax.swing.JFrame(), true);
    ...
    public void preparaEdit(Tarefa tarefa) {
        selecionado = tarefa;
        
        jtfDescricao.setText(tarefa.getDescricao());
        jLabelCodigoTexto.setText(tarefa.getId()+"");
        
    }

    private Tarefa selecionado = null;
