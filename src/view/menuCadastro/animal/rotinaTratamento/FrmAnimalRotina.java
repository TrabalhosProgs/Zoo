 ...
 */
package view.menuCadastro.animal.rotinaTratamento;

import view.menuCadastro.rotinaTratamento.receita.*;
...
import view.menuCadastro.animal.rotinaTratamento.tarefas.FrmVisualizaTarefas;
 ...
 * @author william
 */
public class FrmAnimalRotina extends javax.swing.JDialog {

    /**
     * Creates new form FrmRotinaTarefa
     */
    public FrmAnimalRotina(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void aoSeleciona(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aoSeleciona
        if(jtLista.getSelectedRowCount() == 1){                 
            if(selecionado != null){
                try {
                    selecionado.setRotinaTratamento(lista.get(jtLista.getSelectedRow()));
                    new AnimalDAO().alterar(selecionado);
                    JOptionPane.showMessageDialog(null,"Salvo com sucesso!");
                    setVisible(false);
                } catch (ClassNotFoundException | SQLException ex) {
                    JOptionPane.showMessageDialog(null, "Não foi possivel vincular a Rotina"+ ex);
                } 
            }else{
                selecionadoInclusao.setRotinaTratamento(lista.get(jtLista.getSelectedRow()));
                JOptionPane.showMessageDialog(null,"Salvo com sucesso!");
                setVisible(false);
            }
        }else{
    ...
    private void aoVisualizar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aoVisualizar
        FrmVisualizaTarefas vt = new FrmVisualizaTarefas(null, true);
        vt.preparaVisualizacao(lista.get(jtLista.getSelectedRow()));
        vt.setVisible(true);
    ...
    private void preencheTabela(String data) throws HeadlessException {
        try {
            ...
            for(RotinaTratamento rotina : lista){
                Object[] row = {rotina.getId(),sdf.format(rotina.getDataValidade())};
                dtm.addRow(row);
            }
        } catch (ClassNotFoundException | SQLException ex) {
            JOptionPane.showMessageDialog(null, "Não conseguiu buscar as Rotinas ..."+ ex);
        }
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAnimalRotina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmAnimalRotina dialog = new FrmAnimalRotina(new javax.swing.JFrame(), true);
    ...
    public void vincularRotinaAnimal(Animal a) {
        selecionado = a;
    }
    
    public void vincularRotinaAnimalInclusao(Animal animal) {
        selecionadoInclusao = animal;
    }
    
    //Variaveis criadas manualmente
    private List<RotinaTratamento> lista;
    private Animal selecionado;
    private Animal selecionadoInclusao;
