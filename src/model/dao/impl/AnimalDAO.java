...
public class AnimalDAO implements IGenericDAO<Animal, Integer> {
    ...
    public void inserir(Animal obj) throws ClassNotFoundException, SQLException {
        ...
        String sql = "INSERT INTO animal (nome,"
                + " regiaoOrigem,"
                + " dataNasc, "
                + " peso, "
                + " especie, "
        ...
        pst.setInt(6, obj.getTratadorResponsavel().getId());
        pst.setInt(7, obj.getRotinaTratamento().getId());
    ...
    public void alterar(Animal obj) throws ClassNotFoundException, SQLException {
        ...
        String sql = "UPDATE animal SET nome = ?, "
                ...
                + " especie=?, "
                + " idtratador = ?,"
                + " idrotinatratamento=? WHERE idanimal = ?;";
